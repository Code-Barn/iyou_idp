...
class EcosystemReleasesContextProcessorTest(TestCase):
    ...
    def test_ecosystem_releases_values(self):
        ...
        self.assertEqual(data["IYOU_HOME_FALLBACK_TAG"], "v0.2.0")
    ...
    def test_download_modal_hydration_fallback(self):
        ...
        self.assertIn(
            "https://github.com/Code-Barn/iyou_home/releases/download/v0.2.0/iyou-home_0.2.0_x64-setup.exe",
            html,
        )
        self.assertIn(
            "https://github.com/Code-Barn/iyou_home/releases/download/v0.2.0/iyou-home_0.2.0_x64.dmg",
            html,
        )
        self.assertIn(
            "https://github.com/Code-Barn/iyou_home/releases/download/v0.2.0/iyou-home_0.2.0_amd64.deb",
            html,
        )
        self.assertIn(
            "https://github.com/Code-Barn/iyou_home/releases/download/v0.2.0/iyou-home_0.2.0_amd64.AppImage",
            html,
        )
        self.assertIn(
            "https://github.com/Code-Barn/iyou_home/releases/download/v0.2.0/iyou-home_0.2.0.torrent",
            html,
        )
        self.assertIn("https://ipfs.io/ipns/home.iyou.me/", html)
